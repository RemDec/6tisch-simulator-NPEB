...
LOG_TSCH_NPEB_RX                  = {u'type': u'tsch.npeb.rx',              u'keys': [u'_mote_id',u'packet']}
LOG_TSCH_SLEEP_UNTIL_NEXT_NPEB    = {u'type': u'tsch.npeb.wait',            u'keys': [u'_mote_id',u'target_asn',u'cycles_to_elapse',u'target_cell']}
LOG_TSCH_FEED_NPTABLE             = {u'type': u'tsch.nptable.feed',         u'keys': [u'_mote_id',u'neighbor',u'neighbor_id',u'join_metric',u'signal',u'newScheduleNPEB']}
LOG_TSCH_REGISTER_NPEB_CELL       = {u'type': u'tsch.npebschedule.register',u'keys': [u'_mote_id',u'slotOffset',u'channelOffset',u'nbr_cycles']}
